...
Data downloaded from the Allen Institute Cell Types Database 
...
keep.cells <- which(meta$broad_class %in% c("Gad2_Sepp1", "Gad2_Syt4", "Olig1") |
                      meta$subclass %in% c("Slc17a6_Calb2"))
...
meta.subset$cluster <- meta.subset$subclass
